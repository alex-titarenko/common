...
namespace TAlex.Common.Diagnostics.Logging.Listeners
{
    ...
    public class DailyTraceListenerWrapper<T> : TextWriterTraceListener where T : TextWriterTraceListener
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DailyTraceListenerWrapper{T}"/>
        /// class, using the file as the recipient of the debugging and tracing output.
        /// </summary>
        /// <param name="fileName">The name of the file the <see cref="DailyTraceListenerWrapper{T}"/> writes to.</param>
